...
const _slideLima = function() {
  ...
  slideLima.addEventListener('animationend', () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        slideLima.remove();
        _slideEnam(); // Pindah ke slide baru
      }, 1000);
    }, 6000);
  });
};

// Slide baru untuk foto dan balon
const _slideEnam = function() {
  const slideEnam = document.getElementById('slideEnam');
  slideEnam.classList.remove('d-none');
  
  // Tambahkan efek suara balon
  const balloonSound = new Audio('./music/balloon.mp3');
...
new TypeIt("#teks1", {
  strings: [
    "Selamat ulang tahun! Semoga setiap momen hari ini jadi kenangan indah yang tak terlupakan.",
    "Semoga dalam hidupmu membawa lebih banyak tawa, cinta, dan pencapaian luar biasa.",
    "Semoga setiap harapan yang kamu bisikkan dalam hati hari ini, pelan-pelan menjadi nyata.",
    "Dan semoga kamu selalu dikelilingi oleh orang orang yang mencintaimu tanpa syarat!",
    " ",
